...
0. Подтверждать remote release evidence после изменений в hardening/scale baseline:
  ...
  - последний подтверждённый прогон: `2026-03-02`, run `22574392332` (success), artifacts:
    - `release-scorecard-v2`: `5720290321`
    - `release-supply-chain`: `5720290451`
    - `release-ai-ops`: `5720290568`
