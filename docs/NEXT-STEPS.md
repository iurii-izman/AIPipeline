...
0. Подтверждать remote release evidence после изменений в hardening/scale baseline:
  ...
  - последний подтверждённый прогон: `2026-03-02`, run `22573170009` (success), artifacts:
    - `release-scorecard-v2`: `5719778500`
    - `release-supply-chain`: `5719778672`
    - `release-ai-ops`: `5719778869`
