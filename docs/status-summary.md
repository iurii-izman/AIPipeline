...
- **Stable endpoint active:** `https://n8n.aipipeline.cc` поднят, `/status` и `/deploy staging` подтверждены в Telegram на stable URL; details в `docs/cloudflare-tunnel-setup.md` и `docs/uat-evidence-2026-02-28.md`.
